...
#define DEFAULT_SUSPEND_IDEAL_FREQ 598000
...
#define DEFAULT_TOUCH_POKE_FREQ 747500

#define DEFAULT_BOOST_FREQ 1196000
...
static unsigned int touch_poke_freq = DEFAULT_TOUCH_POKE_FREQ;
 ...
 */
static unsigned int boost_freq = DEFAULT_BOOST_FREQ;
